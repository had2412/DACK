...
import com.example.dack.Activity.DetailActivity;
...
public class FoodListAdapter extends RecyclerView.Adapter<FoodListAdapter.viewholder> {
    ...
    holder.timeTxt.setText(item.get(position).getTimeValue()+" min");
    holder.priceTxt.setText("$"+item.get(position).getPrice());
    holder.rateTxt.setText(""+item.get(position).getStar());
